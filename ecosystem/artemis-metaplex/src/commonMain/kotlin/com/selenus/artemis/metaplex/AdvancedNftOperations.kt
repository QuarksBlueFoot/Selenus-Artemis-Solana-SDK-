...
object AdvancedNftOperations {
    ...
    data class DynamicMetadata(
        ...
        fun updateTrait(name: String, newValue: String): DynamicMetadata {
            val valueHash = sha256(newValue.encodeToByteArray())
    ...
    fun setAndVerifyCollection(
        ...
        val body = byteArrayOf(25) // SetAndVerifyCollection instruction
    ...
    fun unverifyCollection(
        ...
        val body = byteArrayOf(22) // UnverifyCollection instruction
    ...
    private fun generateMintAddress(name: String, payer: Pubkey): Pubkey {
        ...
        val seed = sha256(name.encodeToByteArray() + payer.bytes + currentTimeMillis().toByteArray())
        return Pubkey(seed)
    }
    ...
    private fun createMintAccountInstruction(mint: Pubkey, payer: Pubkey): Instruction {
        ...
        TOKEN_PROGRAM.bytes.copyInto(data, 20)
    ...
    private fun initializeMintInstruction(mint: Pubkey, mintAuthority: Pubkey): Instruction {
        ...
        mintAuthority.bytes.copyInto(data, 2)
    ...
    private fun verifyCollectionInstruction(
        ...
        val body = byteArrayOf(18) // VerifyCollection
    ...
    private fun createMasterEditionInstruction(
        ...
        if (maxSupply != null) {
            body = ByteArray(10)
            body[0] = 17 // CreateMasterEditionV3
            body[1] = 1  // Some(maxSupply)
            writeU64LE(body, 2, maxSupply)
        } else {
            body = byteArrayOf(17, 0) // CreateMasterEditionV3, None
        }
