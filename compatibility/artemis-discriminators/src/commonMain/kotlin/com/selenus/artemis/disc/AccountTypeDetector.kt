...
object AccountTypeDetector {
    ...
    private val knownDiscriminators = mutableMapOf<String, AccountType>()
    private val programAccounts = mutableMapOf<Pubkey, List<RegisteredAccount>>()
...
class InstructionDecoder(
    ...
    private val instructions = mutableMapOf<String, InstructionInfo>()
