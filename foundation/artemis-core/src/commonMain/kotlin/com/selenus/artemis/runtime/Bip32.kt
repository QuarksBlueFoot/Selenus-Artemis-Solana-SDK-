...
object Bip32 {
    ...
    private fun deriveMasterKey(seed: ByteArray): KeyMaterial {
        val result = PlatformCrypto.hmacSha512(
            ED25519_CURVE.encodeToByteArray(),
            seed
        )
    ...
    private fun deriveChildKey(parent: KeyMaterial, level: PathLevel): KeyMaterial {
        ...
        data[0] = 0x00
        parent.key.copyInto(data, destinationOffset = 1, startIndex = 0, endIndex = 32)
        ...
        val result = PlatformCrypto.hmacSha512(parent.chainCode, data)
