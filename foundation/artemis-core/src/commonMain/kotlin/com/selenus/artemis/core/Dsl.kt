...
data class AccountMeta(
    ...
    companion object {
        ...
        fun readonly(pubkey: com.selenus.artemis.runtime.Pubkey) = AccountMeta(pubkey.toBase58(), isSigner = false, isWritable = false)
    }
}
...
class AccountListBuilder {
    ...
    // Pubkey-typed overloads
    fun signerWritable(pubkey: com.selenus.artemis.runtime.Pubkey) = signerWritable(pubkey.toBase58())
    fun signer(pubkey: com.selenus.artemis.runtime.Pubkey) = signer(pubkey.toBase58())
    fun writable(pubkey: com.selenus.artemis.runtime.Pubkey) = writable(pubkey.toBase58())
    fun readonly(pubkey: com.selenus.artemis.runtime.Pubkey) = readonly(pubkey.toBase58())
    fun program(pubkey: com.selenus.artemis.runtime.Pubkey) = program(pubkey.toBase58())
...
class InstructionDataBuilder {
    ...
    /**
     * Write a pubkey (32 bytes) from a base58 string.
     */
    fun writePubkey(base58: String) {
        val decoded = com.selenus.artemis.runtime.Base58.decode(base58)
        require(decoded.size == 32) { "Pubkey must decode to 32 bytes, got ${decoded.size}" }
        writeBytes(decoded)
    }
     ...
     */
    fun writePubkey(pubkey: com.selenus.artemis.runtime.Pubkey) {
        writeBytes(pubkey.bytes)
    }
