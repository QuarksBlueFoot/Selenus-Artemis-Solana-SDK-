...
object Bip39 {
    ...
    fun generate(
        ...
        val entropy = PlatformCrypto.secureRandomBytes(wordCount.entropyBytes)
     ...
     */
    fun generate12Words(): MnemonicResult {
        return generate(WordCount.TWELVE)
    }
    
    /**
     * Generates a 24-word mnemonic phrase.
     */
    fun generate24Words(): MnemonicResult {
        return generate(WordCount.TWENTY_FOUR)
    }
    ...
    fun entropyToMnemonic(entropy: ByteArray): MnemonicResult {
        ...
        // Add checksum bits
        val checksumBits = checksumByte.toString(2).padStart(8, '0')
        ...
        for (i in 0 until wordCount.count) {
            val start = i * 11
            val end = start + 11
            val index = bits.substring(start, end).toInt(2)
    ...
    fun validate(phrase: String) {
        ...
        val expectedChecksum = expectedChecksumByte.toString(2).padStart(8, '0')
    ...
    fun toSeed(phrase: String, passphrase: String = ""): ByteArray {
        ...
        return PlatformCrypto.pbkdf2Sha512(
