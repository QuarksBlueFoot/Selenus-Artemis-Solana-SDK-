...
object Base58 {
   ...
   */
  fun fromBase64(base64: String): String = encode(PlatformBase64.decode(base64))
   ...
   */
  fun toBase64(base58: String): String = PlatformBase64.encode(decode(base58))

  /**
   * Converts a Base64 URL-safe string to Base58.
   */
  fun fromBase64Url(base64Url: String): String = encode(PlatformBase64.urlDecode(base64Url))

  /**
   * Converts a Base58 string to Base64 URL-safe format.
   */
  fun toBase64Url(base58: String): String = PlatformBase64.urlEncode(decode(base58))
