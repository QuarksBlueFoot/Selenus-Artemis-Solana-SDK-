...
dependencies {
    ...
    implementation("xyz.selenus:artemis-ws:2.1.1")
    ...
    implementation("xyz.selenus:artemis-errors:2.1.1")
    implementation("xyz.selenus:artemis-logging:2.1.1")
    implementation("xyz.selenus:artemis-compute:2.1.1")
}
```
...
dependencies {
    ...
    implementation("xyz.selenus:artemis-mplcore:2.1.1")
    implementation("xyz.selenus:artemis-cnft:2.1.1")
    implementation("xyz.selenus:artemis-candy-machine:2.1.1")
}
```
...
dependencies {
    ...
    implementation("xyz.selenus:artemis-solana-pay:2.1.1")
    implementation("xyz.selenus:artemis-anchor:2.1.1")
    implementation("xyz.selenus:artemis-simulation:2.1.1")
}
```
