# Artemis SDK - Technical Architecture

## Module deep dives

This document covers the internal architecture of Artemis's ecosystem and advanced modules. For the overall ring structure and dependency rules, see [ARCHITECTURE_OVERVIEW.md](ARCHITECTURE_OVERVIEW.md).
...
*Technical documentation for Artemis SDK*
