...
object SeedVaultCrypto {
    ...
    @Deprecated(
        message = "This function was never Diffie-Hellman. " +
            "For real ECDH see com.selenus.artemis.wallet.mwa.protocol.MwaSessionCrypto.deriveX25519SharedSecret. " +
    ...
    @Deprecated(
        message = "This function was never Diffie-Hellman. " +
            "See MwaSessionCrypto.deriveX25519SharedSecret (transport layer) or " +
            "deriveDeterministicAppKey (custody layer).",
