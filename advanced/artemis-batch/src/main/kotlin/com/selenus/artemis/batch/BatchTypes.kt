...
/**
 * Describes a write-write conflict between two operations.
 */
data class AccountConflict(
    /** ID of the first conflicting operation */
    val operationA: String,
    /** ID of the second conflicting operation */
    val operationB: String,
    /** Accounts that both operations write to */
    val conflictingAccounts: List<Pubkey>,
    /** Type of conflict */
    val type: ConflictType
)

/**
 * Types of account access conflicts.
 */
enum class ConflictType {
    /** Both operations write to the same account */
    WRITE_WRITE
}
